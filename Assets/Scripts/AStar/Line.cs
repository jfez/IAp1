...
public struct Line
{
    ...
    public Line(Vector2 pointOnLine, Vector2 pointPerpedincularToLine)
    {
        float dx = pointOnLine.x - pointPerpedincularToLine.x;
        float dy = pointOnLine.y - pointPerpedincularToLine.y;
        ...
        approachSide = false;
        approachSide = GetSide(pointPerpedincularToLine);
    }
